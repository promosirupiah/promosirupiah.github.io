...
/**
 * madxartwork typography scheme.
 *
 * madxartwork typography scheme class is responsible for initializing a scheme
 * for typography.
 *
 * @since 1.0.0
 */
class Scheme_Typography extends Scheme_Base {
	...
	public function get_title() {
		return __( 'Typography', 'madxartwork' );
	}
	...
	public function get_disabled_title() {
		return __( 'Default Fonts', 'madxartwork' );
	}
	...
	public function get_scheme_titles() {
		return [
			self::TYPOGRAPHY_1 => __( 'Primary Headline', 'madxartwork' ),
			self::TYPOGRAPHY_2 => __( 'Secondary Headline', 'madxartwork' ),
			self::TYPOGRAPHY_3 => __( 'Body Text', 'madxartwork' ),
			self::TYPOGRAPHY_4 => __( 'Accent Text', 'madxartwork' ),
		];
	}
	...
	public function print_template_content() {
		?>
		<div class="madxartwork-panel-scheme-items"></div>
		<?php
	}
}
