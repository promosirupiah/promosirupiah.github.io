...
/**
 * madxartwork WordPress widgets manager.
 *
 * madxartwork WordPress widgets manager handler class is responsible for
...
class WordPress_Widgets_Manager {
	 ...
	 *
	 * Initializing the WordPress widgets manager in madxartwork editor.
	 *
	 * @since 1.5.0
	 * @access public
	 */
	public function __construct() {
		...
		add_action( 'madxartwork/editor/before_enqueue_scripts', [ $this, 'before_enqueue_scripts' ] );
		add_action( 'madxartwork/editor/footer', [ $this, 'footer' ] );
	}

	/**
	 * Before enqueue scripts.
	 *
	 * Prints custom scripts required to run WordPress widgets in madxartwork
	 * editor.
	 *
	 * Fired by `madxartwork/editor/before_enqueue_scripts` action.
	 *
	 * @since 1.5.0
	 * @access public
	 */
	 ...
	 *
	 * Prints WordPress widgets scripts in madxartwork editor footer.
	 *
	 * Fired by `madxartwork/editor/footer` action.
	 *
	 * @since 1.5.0
	 * @access public
	 */
