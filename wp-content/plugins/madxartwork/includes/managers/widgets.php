...
/**
 * madxartwork widgets manager.
 *
 * madxartwork widgets manager handler class is responsible for registering and
 * initializing all the supported madxartwork widgets.
 *
 * @since 1.0.0
 */
class Widgets_Manager {
	 ...
	 * Init widgets.
	 *
	 * Initialize madxartwork widgets manager. Include all the the widgets files
	 * and register each madxartwork and WordPress widget.
	 *
	 * @since 2.0.0
	 * @access private
	*/
	private function init_widgets() {
		...
		foreach ( $build_widgets_filename as $widget_filename ) {
			include( madxartwork_PATH . 'includes/widgets/' . $widget_filename . '.php' );
		 ...
		 *
		 * Fires after madxartwork widgets are registered.
		 *
		 * @since 1.0.0
		 *
		 * @param Widgets_Manager $this The widgets manager.
		 */
		do_action( 'madxartwork/widgets/widgets_registered', $this );
	}
	 ...
	 *
	 * Exclude the widgets that are in madxartwork widgets black list. Theme and
	...
	*/
	private function register_wp_widgets() {
		...
		/**
		 * madxartwork widgets black list.
		 *
		 ...
		 */
		$black_list = apply_filters( 'madxartwork/widgets/black_list', $black_list );
		...
		foreach ( $wp_widget_factory->widgets as $widget_class => $widget_obj ) {
			...
			$madxartwork_widget_class = __NAMESPACE__ . '\Widget_WordPress';

			$this->register_widget_type(
				new $madxartwork_widget_class( [], [
	 ...
	 * Require files.
	 *
	 * Require madxartwork widget base class.
	 *
	 * @since 2.0.0
	 * @access private
	*/
	private function require_files() {
		require madxartwork_PATH . 'includes/base/widget-base.php';
	}
	 ...
	 * @access public
	 *
	 * @param Widget_Base $widget madxartwork widget.
	 *
	...
	*/
	 ...
	 * Ajax render widget.
	 *
	 * Ajax handler for madxartwork render_widget.
	 *
	 * Fired by `wp_ajax_madxartwork_render_widget` action.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Ajax handler for madxartwork editor get_wp_widget_form.
	 *
	 * Fired by `wp_ajax_madxartwork_editor_get_wp_widget_form` action.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	*/
	 ...
	 *
	 * Initializing madxartwork widgets manager.
	 *
	 * @since 1.0.0
	 * @access public
	*/
