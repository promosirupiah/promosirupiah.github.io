...
/**
 * madxartwork images manager.
 *
 * madxartwork images manager handler class is responsible for retrieving image
 * details.
 *
 * @since 1.0.0
 */
class Images_Manager {
	 ...
	 *
	 * Fired by `wp_ajax_madxartwork_get_images_details` action.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	 ...
	 *
	 * Fired by `wp_ajax_madxartwork_get_image_details` action.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function get_details( $id, $size, $is_first_time ) {
		if ( ! class_exists( 'Group_Control_Image_Size' ) ) {
			require_once madxartwork_PATH . '/includes/controls/groups/image-size.php';
		}
	 ...
	 *
	 * Initializing madxartwork images manager.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function __construct() {
		add_action( 'wp_ajax_madxartwork_get_images_details', [ $this, 'get_images_details' ] );
	}
}
