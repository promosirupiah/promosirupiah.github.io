...
/**
 * madxartwork skins manager.
 *
 * madxartwork skins manager handler class is responsible for registering and
...
class Skins_Manager {
	 ...
	 * @param Skin_Base   $skin   madxartwork skin.
	 *
	 ...
	 *
	 * @param Widget_Base $widget  madxartwork widget.
	 * @param string      $skin_id madxartwork skin ID.
	 *
	 ...
	 *
	 * Initializing madxartwork skins manager by requiring the skin base class.
	 *
	 * @since 1.0.0
	 * @access public
	 */
	public function __construct() {
		require madxartwork_PATH . 'includes/base/skin-base.php';
	}
}
