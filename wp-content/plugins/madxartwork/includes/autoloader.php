...
/**
 * madxartwork autoloader.
 *
 * madxartwork autoloader handler class is responsible for loading the different
...
class Autoloader {
	 ...
	 * Classes map.
	 *
	 * Maps madxartwork classes to file names.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
	 *
	 * @var array Classes used by madxartwork.
	 */
	 ...
	 * Classes aliases.
	 *
	 * Maps madxartwork classes to aliases.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
	 ...
	 * reference : https://github.com/madxartwork/madxartwork/issues/7310#issuecomment-469593385
	 *
	 * @param $string
	...
	private static function load_class( $relative_class_name ) {
		...
		if ( isset( $classes_map[ $relative_class_name ] ) ) {
			$filename = madxartwork_PATH . '/' . $classes_map[ $relative_class_name ];
		} else {
			$filename = strtolower(
				preg_replace(
					[ '/([a-z])([A-Z])/', '/_/', '/\\\/' ],
			...
			$filename = madxartwork_PATH . $filename . '.php';
		}
