...
abstract class Controls_Stack extends Base_Object {
	 ...
	 * The configuration.
	 *
	 * Holds the configuration used to generate the madxartwork editor. It includes
	...
	public function start_controls_section( $section_id, array $args = [] ) {
		 ...
		 *
		 * Fires before madxartwork section starts in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 ...
		 */
		do_action( 'madxartwork/element/before_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "madxartwork/element/{$section_name}/{$section_id}/before_section_start", $this, $args );
		...
		if ( null !== $this->current_section ) {
			wp_die( sprintf( 'madxartwork: You can\'t start a section before the end of the previous section "%s".', $this->current_section['section'] ) ); // XSS ok.
		}
		 ...
		 * After section start.
		 *
		 * Fires after madxartwork section starts in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
		 ...
		 * @param array          $args       Section arguments.
		 */
		do_action( 'madxartwork/element/after_section_start', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "madxartwork/element/{$section_name}/{$section_id}/after_section_start", $this, $args );
	}
	...
	public function end_controls_section() {
		 ...
		 * Before section end.
		 *
		 * Fires before madxartwork section ends in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
		 ...
		 * @param array          $args       Section arguments.
		 */
		do_action( 'madxartwork/element/before_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "madxartwork/element/{$stack_name}/{$section_id}/before_section_end", $this, $args );
		 ...
		 * After section end.
		 *
		 * Fires after madxartwork section ends in the editor panel.
		 *
		 * @since 1.4.0
		 *
		 * @param Controls_Stack $this       The control.
		 ...
		 * @param array          $args       Section arguments.
		 */
		do_action( 'madxartwork/element/after_section_end', $this, $section_id, $args );
		 ...
		 * @param array          $args Section arguments.
		 */
		do_action( "madxartwork/element/{$stack_name}/{$section_id}/after_section_end", $this, $args );
	}
	...
	public function start_controls_tabs( $tabs_id, array $args = [] ) {
		if ( null !== $this->current_tab ) {
			wp_die( sprintf( 'madxartwork: You can\'t start tabs before the end of the previous tabs "%s".', $this->current_tab['tabs_wrapper'] ) ); // XSS ok.
		}
	...
	public function start_controls_tab( $tab_id, $args ) {
		if ( ! empty( $this->current_tab['inner_tab'] ) ) {
			wp_die( sprintf( 'madxartwork: You can\'t start a tab before the end of the previous tab "%s".', $this->current_tab['inner_tab'] ) ); // XSS ok.
		}
	...
	public function print_template() {
		 ...
		 */
		$template_content = apply_filters( "madxartwork/{$element_type}/print_template", $template_content, $this );

		if ( empty( $template_content ) ) {
			return;
		}
		?>
		<script type="text/html" id="tmpl-madxartwork-<?php echo esc_attr( $this->get_name() ); ?>-content">
