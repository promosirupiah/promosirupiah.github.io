 ...
 * madxartwork fonts.
 *
 * madxartwork fonts handler class is responsible for registering the supported
 * fonts used by madxartwork.
 *
 * @since 1.0.0
 */
class Fonts {
	...
	public static function get_font_groups() {
		if ( null === self::$font_groups ) {
			$font_groups = [
				self::SYSTEM => __( 'System', 'madxartwork' ),
				self::GOOGLE => __( 'Google', 'madxartwork' ),
				self::EARLYACCESS => __( 'Google Early Access', 'madxartwork' ),
			];

			/**
			 * Font groups.
			 *
			 * Filters the fonts groups used by madxartwork.
			 *
			 * @since 1.9.4
			 *
			 * @param array $font_groups Font groups.
			 */
			$font_groups = apply_filters( 'madxartwork/fonts/groups', $font_groups );
	...
	public static function get_fonts() {
		if ( null === self::$fonts ) {
			 ...
			 * Additional fonts.
			 *
			 * Filters the fonts used by madxartwork to add additional fonts.
			 *
			 * @since 1.9.4
			 *
			 * @param array $additional_fonts Additional madxartwork fonts.
			 */
			$additional_fonts = apply_filters( 'madxartwork/fonts/additional_fonts', $additional_fonts );
