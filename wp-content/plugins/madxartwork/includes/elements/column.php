...
/**
 * madxartwork column element.
 *
 * madxartwork column handler class is responsible for initializing the column
 * element.
 *
 * @since 1.0.0
 */
class Element_Column extends Element_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			'_inline_size',
			[
				'label' => __( 'Column Width', 'madxartwork' ) . ' (%)',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'.madxartwork-bc-flex-widget {{WRAPPER}}.madxartwork-column .madxartwork-column-wrap' => 'align-items: {{VALUE}}',
					// This specificity is intended to make sure column css overwrites section css on vertical alignment (content_position)
					'{{WRAPPER}}.madxartwork-column.madxartwork-element[data-element_type="column"] > .madxartwork-column-wrap.madxartwork-element-populated > .madxartwork-widget-wrap' => 'align-content: {{VALUE}}; align-items: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			'align',
			[
				'label' => __( 'Horizontal Align', 'madxartwork' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => __( 'Default', 'madxartwork' ),
					'flex-start' => __( 'Start', 'madxartwork' ),
					'center' => __( 'Center', 'madxartwork' ),
					'flex-end' => __( 'End', 'madxartwork' ),
					'space-between' => __( 'Space Between', 'madxartwork' ),
					'space-around' => __( 'Space Around', 'madxartwork' ),
					'space-evenly' => __( 'Space Evenly', 'madxartwork' ),
				],
				'selectors' => [
					'{{WRAPPER}}.madxartwork-column > .madxartwork-column-wrap > .madxartwork-widget-wrap' => 'justify-content: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'placeholder' => 20,
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-column-wrap > .madxartwork-widget-wrap > .madxartwork-widget:not(.madxartwork-widget__width-auto):not(.madxartwork-widget__width-initial):not(:last-child):not(.madxartwork-absolute)' => 'margin-bottom: {{VALUE}}px', //Need the full path for exclude the inner section
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:not(.madxartwork-motion-effects-element-type-background) > .madxartwork-element-populated, {{WRAPPER}} > .madxartwork-column-wrap > .madxartwork-motion-effects-container > .madxartwork-motion-effects-layer',
				'fields_options' => [
					'background' => [
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover > .madxartwork-element-populated',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} > .madxartwork-element-populated >  .madxartwork-background-overlay',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated >  .madxartwork-background-overlay' => 'opacity: {{SIZE}};',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated > .madxartwork-background-overlay' => 'mix-blend-mode: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}}:hover > .madxartwork-element-populated >  .madxartwork-background-overlay',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}:hover > .madxartwork-element-populated >  .madxartwork-background-overlay' => 'opacity: {{SIZE}};',
				],
				'condition' => [
		...
		$this->add_group_control(
			...
			[
				'name' => 'border',
				'selector' => '{{WRAPPER}} > .madxartwork-element-populated',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated, {{WRAPPER}} > .madxartwork-element-populated > .madxartwork-background-overlay' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}}:hover > .madxartwork-element-populated, {{WRAPPER}}:hover > .madxartwork-element-populated > .madxartwork-background-overlay' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated' => 'transition: background {{background_hover_transition.SIZE}}s, border {{SIZE}}s, border-radius {{SIZE}}s, box-shadow {{SIZE}}s',
					'{{WRAPPER}} > .madxartwork-element-populated > .madxartwork-background-overlay' => 'transition: background {{background_overlay_hover_transition.SIZE}}s, border-radius {{SIZE}}s, opacity {{background_overlay_hover_transition.SIZE}}s',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .madxartwork-element-populated .madxartwork-heading-title' => 'color: {{VALUE}};',
				],
				'separator' => 'none',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .madxartwork-element-populated a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'selectors' => [
					'{{WRAPPER}} .madxartwork-element-populated a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} > .madxartwork-element-populated' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function _content_template() {
		...
		<div class="madxartwork-column-wrap">
			...
			<div class="madxartwork-widget-wrap"></div>
		</div>
		<?php
	}
	...
	public function before_render() {
		...
		$column_wrap_classes = [ 'madxartwork-column-wrap' ];

		if ( $this->get_children() ) {
			$column_wrap_classes[] = ' madxartwork-element-populated';
		}
		...
		$this->add_render_attribute( [
			...
			'_widget_wrapper' => [
				'class' => [ 'madxartwork-widget-wrap' ],
			],
			'_background_overlay' => [
				'class' => [ 'madxartwork-background-overlay' ],
			],
		] );
		?>
	...
	protected function _add_render_attributes() {
		...
		$this->add_render_attribute(
			'_wrapper', 'class', [
				'madxartwork-column',
				'madxartwork-col-' . $settings['_column_size'],
				'madxartwork-' . $column_type . '-column',
			]
		);
	}
