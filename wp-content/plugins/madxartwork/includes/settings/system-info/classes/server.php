<?php
namespace madxartwork\System_Info\Classes;
...
/**
 * madxartwork server environment report.
 *
...
class Server_Reporter extends Base_Reporter {
	...
	public function get_fields() {
		return [
			...
			'madxartwork_library' => 'madxartwork Library',
		];
	}
	...
	public function get_php_version() {
		...
		if ( version_compare( $result['value'], '5.4', '<' ) ) {
			$result['recommendation'] = _x( 'We recommend to use php 5.4 or higher', 'System Info', 'madxartwork' );
	...
	public function get_write_permissions() {
		...
		$madxartwork_uploads_path = $wp_upload_dir['basedir'] . '/madxartwork';

		if ( is_dir( $madxartwork_uploads_path ) ) {
			$paths_to_check[ $madxartwork_uploads_path ] = 'madxartwork uploads directory';
		}
	...
	/**
	 * Check for madxartwork library connectivity.
	 *
	 * Check whether the remote madxartwork library is reachable.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *    Report data.
	 *
	 *    @type string $value   The status of madxartwork library connectivity.
	 *    @type bool   $warning Whether to display a warning. True if madxartwork
	 * *                        library is not reachable, False otherwise.
	 * }
	 */
	public function get_madxartwork_library() {
