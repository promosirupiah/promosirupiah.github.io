...
/**
 * madxartwork settings controls.
 *
 * madxartwork settings controls handler class responsible for creating the final
 * HTML for various input field types used in madxartwork settings pages.
 *
 * @since 1.0.0
 */
class Settings_Controls {
	...
	private static function checkbox_list_roles( array $field ) {
		...
		if ( is_multisite() ) {
			$roles = [
				'super_admin' => [
					'name' => __( 'Super Admin', 'madxartwork' ),
				],
			] + $roles;
		}
