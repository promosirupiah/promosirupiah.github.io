...
class Control_URL extends Control_Base_Multiple {
	...
	protected function get_default_settings() {
		return [
			'label_block' => true,
			'show_external' => true,
			'placeholder' => __( 'Paste URL or type', 'madxartwork' ),
			'autocomplete' => true,
			'dynamic' => [
	...
	public function content_template() {
		...
		?>
		<div class="madxartwork-control-field madxartwork-control-url-external-{{{ data.show_external ? 'show' : 'hide' }}}">
			...
			<div class="madxartwork-control-input-wrapper">
				...
				<input id="<?php echo $control_uid; ?>" class="madxartwork-control-tag-area madxartwork-input" data-setting="url" placeholder="{{ data.placeholder }}" />
				<input id="_ajax_linking_nonce" type="hidden" value="<?php echo wp_create_nonce( 'internal-linking' ); ?>" />

				<label for="<?php echo $more_input_control_uid; ?>" class="madxartwork-control-url-more tooltip-target" data-tooltip="<?php echo __( 'Link Options', 'madxartwork' ); ?>">
					<i class="eicon-cog" aria-hidden="true"></i>
				</label>
				<input id="<?php echo $more_input_control_uid; ?>" type="checkbox" class="madxartwork-control-url-more-input">
				<div class="madxartwork-control-url-more-options">
					<div class="madxartwork-control-url-option">
						<input id="<?php echo $is_external_control_uid; ?>" type="checkbox" class="madxartwork-control-url-option-input" data-setting="is_external">
						<label for="<?php echo $is_external_control_uid; ?>"><?php echo __( 'Open in new window', 'madxartwork' ); ?></label>
					</div>
					<div class="madxartwork-control-url-option">
						<input id="<?php echo $nofollow_control_uid; ?>" type="checkbox" class="madxartwork-control-url-option-input" data-setting="nofollow">
						<label for="<?php echo $nofollow_control_uid; ?>"><?php echo __( 'Add nofollow', 'madxartwork' ); ?></label>
					</div>
				</div>
			</div>
		</div>
