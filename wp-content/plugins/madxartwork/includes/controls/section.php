...
class Control_Section extends Base_UI_Control {
	...
	public function content_template() {
		...
		<div class="madxartwork-panel-heading">
			<div class="madxartwork-panel-heading-toggle madxartwork-section-toggle" data-collapse_id="{{ data.name }}">
				<i class="eicon" aria-hidden="true"></i>
			</div>
			<div class="madxartwork-panel-heading-title madxartwork-section-title">{{{ data.label }}}</div>
		</div>
		<?php
	}
