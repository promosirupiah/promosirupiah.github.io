	...
	public function content_template() {
		...
		<div class="madxartwork-control-field">
			...
			<div class="madxartwork-control-input-wrapper">
				<input id="<?php echo $control_uid; ?>" placeholder="{{ data.placeholder }}" class="madxartwork-date-time-picker flatpickr" type="text" data-setting="{{ data.name }}">
			</div>
		</div>
		<# if ( data.description ) { #>
