...
class Control_Gallery extends Base_Data_Control {
	 ...
	 * madxartwork template JSON file, and replacing the old data.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	public function content_template() {
		...
		<div class="madxartwork-control-field">
			<div class="madxartwork-control-title">{{{ data.label }}}</div>
			<div class="madxartwork-control-input-wrapper">
				<# if ( data.description ) { #>
				<div class="madxartwork-control-field-description">{{{ data.description }}}</div>
				<# } #>
				<div class="madxartwork-control-media__content madxartwork-control-tag-area">
					<div class="madxartwork-control-gallery-status">
						<span class="madxartwork-control-gallery-status-title"></span>
						<span class="madxartwork-control-gallery-clear"><i class="eicon-trash" aria-hidden="true"></i></span>
					</div>
					<div class="madxartwork-control-gallery-content">
						<div class="madxartwork-control-gallery-thumbnails"></div>
						<div class="madxartwork-control-gallery-edit"><span><i class="eicon-pencil" aria-hidden="true"></i></span></div>
						<button class="madxartwork-button madxartwork-control-gallery-add" aria-label="<?php echo __( 'Add Images', 'madxartwork' ); ?>"><i class="eicon-plus-circle" aria-hidden="true"></i></button>
					</div>
				</div>
			</div>
		</div>
