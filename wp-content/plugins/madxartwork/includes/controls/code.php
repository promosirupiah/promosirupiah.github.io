	...
	public function content_template() {
		...
		<div class="madxartwork-control-field">
			...
			<div class="madxartwork-control-input-wrapper">
				<textarea id="<?php echo $control_uid; ?>" rows="{{ data.rows }}" class="madxartwork-input-style madxartwork-code-editor" data-setting="{{ data.name }}"></textarea>
			</div>
		</div>
		<# if ( data.description ) { #>
