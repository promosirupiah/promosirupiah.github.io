...
/**
 * madxartwork hover animation control.
 *
...
class Control_Hover_Animation extends Base_Data_Control {
	...
	public static function get_animations() {
		if ( is_null( self::$_animations ) ) {
			 ...
			 */
			$additional_animations = apply_filters( 'madxartwork/controls/hover_animations/additional_animations', $additional_animations );
		...
		<div class="madxartwork-control-field">
			...
			<div class="madxartwork-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" data-setting="{{ data.name }}">
					<option value=""><?php echo __( 'None', 'madxartwork' ); ?></option>
