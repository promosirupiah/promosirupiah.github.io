...
class Control_Animation extends Base_Data_Control {
	...
	public static function get_animations() {
		 ...
		 */
		$additional_animations = apply_filters( 'madxartwork/controls/animations/additional_animations', [] );
		...
		<div class="madxartwork-control-field">
			...
			<div class="madxartwork-control-input-wrapper">
				<select id="<?php echo $control_uid; ?>" data-setting="{{ data.name }}">
					...
					<option value="none"><?php echo __( 'None', 'madxartwork' ); ?></option>
