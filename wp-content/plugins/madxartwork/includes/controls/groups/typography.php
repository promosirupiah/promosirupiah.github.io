...
/**
 * madxartwork typography control.
 *
...
class Group_Control_Typography extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$default_fonts = SettingsManager::get_settings_managers( 'general' )->get_model()->get_settings( 'madxartwork_default_generic_fonts' );
		...
		$fields['font_family'] = [
			'label' => _x( 'Family', 'Typography Control', 'madxartwork' ),
		...
		$fields['font_size'] = [
			'label' => _x( 'Size', 'Typography Control', 'madxartwork' ),
		...
		$fields['font_weight'] = [
			'label' => _x( 'Weight', 'Typography Control', 'madxartwork' ),
		...
		$fields['text_transform'] = [
			'label' => _x( 'Transform', 'Typography Control', 'madxartwork' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => __( 'Default', 'madxartwork' ),
				'uppercase' => _x( 'Uppercase', 'Typography Control', 'madxartwork' ),
				'lowercase' => _x( 'Lowercase', 'Typography Control', 'madxartwork' ),
				'capitalize' => _x( 'Capitalize', 'Typography Control', 'madxartwork' ),
				'none' => _x( 'Normal', 'Typography Control', 'madxartwork' ),
			],
		];

		$fields['font_style'] = [
			'label' => _x( 'Style', 'Typography Control', 'madxartwork' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => __( 'Default', 'madxartwork' ),
				'normal' => _x( 'Normal', 'Typography Control', 'madxartwork' ),
				'italic' => _x( 'Italic', 'Typography Control', 'madxartwork' ),
				'oblique' => _x( 'Oblique', 'Typography Control', 'madxartwork' ),
			],
		];

		$fields['text_decoration'] = [
			'label' => _x( 'Decoration', 'Typography Control', 'madxartwork' ),
			'type' => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				'' => __( 'Default', 'madxartwork' ),
				'underline' => _x( 'Underline', 'Typography Control', 'madxartwork' ),
				'overline' => _x( 'Overline', 'Typography Control', 'madxartwork' ),
				'line-through' => _x( 'Line Through', 'Typography Control', 'madxartwork' ),
				'none' => _x( 'None', 'Typography Control', 'madxartwork' ),
			],
		];

		$fields['line_height'] = [
			'label' => _x( 'Line-Height', 'Typography Control', 'madxartwork' ),
			'type' => Controls_Manager::SLIDER,
			'desktop_default' => [
				'unit' => 'em',
			],
		...
		$fields['letter_spacing'] = [
			'label' => _x( 'Letter Spacing', 'Typography Control', 'madxartwork' ),
			'type' => Controls_Manager::SLIDER,
			'range' => [
				'px' => [
					'min' => -5,
	...
	protected function get_default_options() {
		return [
			'popover' => [
				...
				'starter_title' => _x( 'Typography', 'Typography Control', 'madxartwork' ),
				'settings' => [
					'render_type' => 'ui',
				],
			],
