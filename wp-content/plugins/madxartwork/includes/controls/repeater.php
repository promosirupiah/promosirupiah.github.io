...
class Control_Repeater extends Base_Data_Control {
	 ...
	 * Import repeater.
	 *
	 * Used as a wrapper method for inner controls while importing madxartwork
	...
	public function content_template() {
		?>
		<label>
			<span class="madxartwork-control-title">{{{ data.label }}}</span>
		</label>
		<div class="madxartwork-repeater-fields-wrapper"></div>
		<# if ( itemActions.add ) { #>
			<div class="madxartwork-button-wrapper">
				<button class="madxartwork-button madxartwork-button-default madxartwork-repeater-add" type="button">
					<i class="eicon-plus" aria-hidden="true"></i><?php echo __( 'Add Item', 'madxartwork' ); ?>
				</button>
			</div>
		<# } #>
		<?php
