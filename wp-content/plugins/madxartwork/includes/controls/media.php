			...
			<div class="madxartwork-control-input-wrapper madxartwork-aspect-ratio-219">
				<div class="madxartwork-control-media__content madxartwork-control-tag-area madxartwork-control-preview-area madxartwork-fit-aspect-ratio">
					...
					<div class="madxartwork-control-media-area madxartwork-fit-aspect-ratio">
						...
						<video class="madxartwork-control-media-video" preload="metadata"></video>
						<i class="eicon-video-camera"></i>
						<# } #>
					</div>
					<div class="madxartwork-control-media__tools">
						<# if( 'image' === data.media_type ) { #>
						<div class="madxartwork-control-media__tool madxartwork-control-media__replace"><?php echo __( 'Choose Image', 'madxartwork' ); ?></div>
						<# } else if( 'video' === data.media_type ) { #>
						<div class="madxartwork-control-media__tool madxartwork-control-media__replace"><?php echo __( 'Choose Video', 'madxartwork' ); ?></div>
						<# } #>
					</div>
				</div>
			</div>
