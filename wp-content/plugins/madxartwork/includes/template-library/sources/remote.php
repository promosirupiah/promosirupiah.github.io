 ...
 * handling remote templates from madxartwork.net servers.
 *
 * @since 1.0.0
 */
class Source_Remote extends Source_Base {
	 ...
	 *
	 * Retrieve remote templates from madxartwork.net servers.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 * Get remote template.
	 *
	 * Retrieve a single remote template from madxartwork.net servers.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Remote template from madxartwork.net servers cannot be saved on the
	 ...
	 *
	 * Remote template from madxartwork.net servers cannot be updated on the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Remote template from madxartwork.net servers cannot be deleted from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Remote template from madxartwork.net servers cannot be exported from the
	 * database as they are retrieved from remote servers.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Retrieve the data of a single remote template from madxartwork.net servers.
	 *
	 * @since 1.5.0
	 * @access public
	 *
