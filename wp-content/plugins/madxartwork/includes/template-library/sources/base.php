...
/**
 * madxartwork template library source base.
 *
 * madxartwork template library source base handler class is responsible for
 * initializing all the methods controlling the source of madxartwork templates.
 *
 * @since 1.0.0
 * @abstract
 */
abstract class Source_Base {
	 ...
	 *
	 * Retrieve madxartwork meta data for the current user.
	 *
	 * @since 1.9.0
	 * @access public
	 *
	 ...
	 *
	 * For any given madxartwork content/data, replace the IDs with new randomly
	 * generated IDs.
	 *
	 * @since 1.0.0
	 * @access protected
	 *
	 * @param array $content Any type of madxartwork data.
	 *
	...
	/**
	 * Get madxartwork library user meta prefix.
	 *
	 * Retrieve user meta prefix used to save madxartwork data.
	 *
	 * @since 1.9.0
	 * @access protected
	 *
	...
	protected function get_user_meta_prefix() {
		return 'madxartwork_library_' . $this->get_id();
	}
