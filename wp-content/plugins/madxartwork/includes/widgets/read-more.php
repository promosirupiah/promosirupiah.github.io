...
/**
 * madxartwork HTML widget.
 *
 * madxartwork widget that insert a custom HTML code into the page.
 *
 */
class Widget_Read_More extends Widget_Base {
	...
	public function get_title() {
		return __( 'Read More', 'madxartwork' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Read More', 'madxartwork' ),
			]
		);

		$default_link_text = apply_filters( 'madxartwork/widgets/read_more/default_link_text', __( 'Continue reading', 'madxartwork' ) );

		$this->add_control(
			'theme_support',
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => sprintf( __( 'Note: This widget only affects themes that use `%s` in archive pages.', 'madxartwork' ), 'the_content' ),
		...
		$this->add_control(
			'link_text',
			[
				'label' => __( 'Read More Text', 'madxartwork' ),
