...
/**
 * madxartwork sidebar widget.
 *
 * madxartwork widget that insert any sidebar into the page.
 *
 * @since 1.0.0
 */
class Widget_Sidebar extends Widget_Base {
	...
	protected function _register_controls() {
		...
		if ( ! $wp_registered_sidebars ) {
			$options[''] = __( 'No sidebars were found', 'madxartwork' );
		} else {
			$options[''] = __( 'Choose Sidebar', 'madxartwork' );
		...
		$this->start_controls_section(
			'section_sidebar',
			[
				'label' => __( 'Sidebar', 'madxartwork' ),
			]
		);

		$this->add_control( 'sidebar', [
			'label' => __( 'Choose Sidebar', 'madxartwork' ),
