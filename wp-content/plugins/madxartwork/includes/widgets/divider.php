...
/**
 * madxartwork divider widget.
 *
 * madxartwork widget that displays a line that divides different elements in the
 * page.
 *
 * @since 1.0.0
 */
class Widget_Divider extends Widget_Base {
	...
	private static function get_additional_styles() {
		 ...
		 * Additional Styles.
		 *
		 * Filters the styles used by madxartwork to add additional divider styles.
		 *
		 * @since 2.7.0
		 *
		 * @param array $additional_styles Additional madxartwork divider styles.
		 */
		$additional_styles = apply_filters( 'madxartwork/divider/styles/additional_styles', $additional_styles );
		return $additional_styles;
	}
	...
	private function get_separator_styles() {
		return array_merge(
			...
			[
				'curly'   => [
					'label' => _x( 'Curly', 'shapes', 'madxartwork' ),
				...
				'curved'   => [
					'label' => _x( 'Curved', 'shapes', 'madxartwork' ),
				...
				'multiple'   => [
					'label' => _x( 'Multiple', 'shapes', 'madxartwork' ),
				...
				'slashes' => [
					'label' => _x( 'Slashes', 'shapes', 'madxartwork' ),
				...
				'squared' => [
					'label' => _x( 'Squared', 'shapes', 'madxartwork' ),
				...
				'wavy'   => [
					'label' => _x( 'Wavy', 'shapes', 'madxartwork' ),
				...
				'zigzag'  => [
					'label' => _x( 'Zigzag', 'shapes', 'madxartwork' ),
				...
				'arrows'   => [
					'label' => _x( 'Arrows', 'shapes', 'madxartwork' ),
				...
				'pluses'   => [
					'label' => _x( 'Pluses', 'shapes', 'madxartwork' ),
				...
				'rhombus'   => [
					'label' => _x( 'Rhombus', 'shapes', 'madxartwork' ),
				...
				'parallelogram'   => [
					'label' => _x( 'Parallelogram', 'shapes', 'madxartwork' ),
				...
				'rectangles'   => [
					'label' => _x( 'Rectangles', 'shapes', 'madxartwork' ),
				...
				'dots_tribal'   => [
					'label' => _x( 'Dots', 'shapes', 'madxartwork' ),
				...
				'trees_2_tribal'   => [
					'label' => _x( 'Fir Tree', 'shapes', 'madxartwork' ),
				...
				'rounds_tribal'   => [
					'label' => _x( 'Half Rounds', 'shapes', 'madxartwork' ),
				...
				'leaves_tribal'   => [
					'label' => _x( 'Leaves', 'shapes', 'madxartwork' ),
				...
				'stripes_tribal'   => [
					'label' => _x( 'Stripes', 'shapes', 'madxartwork' ),
				...
				'squares_tribal'   => [
					'label' => _x( 'Squares', 'shapes', 'madxartwork' ),
				...
				'trees_tribal'   => [
					'label' => _x( 'Trees', 'shapes', 'madxartwork' ),
				...
				'planes_tribal'   => [
					'label' => _x( 'Tribal', 'shapes', 'madxartwork' ),
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'pattern',
				'prefix_class' => 'madxartwork-widget-divider--separator-type-',
				'condition' => [
					'style!' => [
						'',
						'solid',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HIDDEN,
				'default' => 'no-spacing',
				'prefix_class' => 'madxartwork-widget-divider--',
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-divider-separator' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-divider' => 'text-align: {{VALUE}}',
					'{{WRAPPER}} .madxartwork-divider-separator' => 'margin: 0 auto; margin-{{VALUE}}: 0',
				],
			]
		);
		...
		$this->add_control(
			'look',
			[
				'label' => __( 'Add Element', 'madxartwork' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'line' => [
						'title' => __( 'None', 'madxartwork' ),
						'icon' => 'eicon-ban',
					],
					'line_text' => [
						'title' => __( 'Text', 'madxartwork' ),
						'icon' => 'eicon-t-letter-bold',
					],
					'line_icon' => [
						'title' => __( 'Icon', 'madxartwork' ),
						'icon' => 'eicon-star',
					],
				],
				'separator' => 'before',
				'prefix_class' => 'madxartwork-widget-divider--view-',
				'render_type' => 'template',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Divider', 'madxartwork' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-divider' => 'padding-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-divider__text' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .madxartwork-divider__text',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'center',
				'prefix_class' => 'madxartwork-widget-divider--element-align-',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .madxartwork-icon' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'icon_view!' => 'default',
				],
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'madxartwork-divider' );
		...
		<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			...
			<?php if ( $has_icon ) : ?>
				<div class="madxartwork-icon madxartwork-divider__element">
					<?php
			...
			<?php elseif ( $has_text ) :
				...
				$this->add_render_attribute( 'text', [ 'class' => [ 'madxartwork-divider__text', 'madxartwork-divider__element' ] ] );
				?>
