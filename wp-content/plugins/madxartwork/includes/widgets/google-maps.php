...
/**
 * madxartwork google maps widget.
 *
 * madxartwork widget that displays an embedded google map.
 *
 * @since 1.0.0
 */
class Widget_Google_Maps extends Widget_Base {
	...
	public function get_title() {
		return __( 'Google Maps', 'madxartwork' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_map',
			[
				'label' => __( 'Map', 'madxartwork' ),
			]
		);

		$default_address = __( 'London Eye, London, United Kingdom', 'madxartwork' );
		$this->add_control(
			'address',
			[
				'label' => __( 'Location', 'madxartwork' ),
	...
	protected function render() {
		...
		printf(
			'<div class="madxartwork-custom-embed"><iframe frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?q=%s&amp;t=m&amp;z=%d&amp;output=embed&amp;iwloc=near" aria-label="%s"></iframe></div>',
