<?php
namespace madxartwork\Modules\Library\Documents;
...
/**
 * madxartwork library document.
 *
 * madxartwork library document handler class is responsible for handling
...
abstract class Library_Document extends Document {
	...
	public function print_admin_column_type() {
		$admin_filter_url = admin_url( Source_Local::ADMIN_MENU_SLUG . '&madxartwork_library_type=' . $this->get_name() );
