...
/**
 * madxartwork Page Builder cli tools.
 */
class Command extends \WP_CLI_Command {

	/**
	 * Flush the madxartwork Page Builder CSS Cache.
	 *
	 * [--network]
	 ...
	 * ## EXAMPLES
	 *
	 *  1. wp madxartwork flush-css
	 *      - This will flush the CSS files for madxartwork page builder.
	 *
	 *  2. wp madxartwork flush-css --network
	 *      - This will flush the CSS files for madxartwork page builder for all the sites in the network.
	 *
	 * @since 2.1.0
	 * @access public
	 * @alias flush-css
	...
	public function flush_css( $args, $assoc_args ) {
		...
		if ( $network ) {
			...
			foreach ( $blogs as $keys => $blog ) {
				...
				\WP_CLI::success( 'Flushed the madxartwork CSS Cache for site - ' . get_option( 'home' ) );
			...
			\WP_CLI::success( 'Flushed the madxartwork CSS Cache' );
		}
	}

	/**
	 * Replace old URLs with new URLs in all madxartwork pages.
	 *
	 * ## EXAMPLES
	 *
	 *  1. wp madxartwork replace-urls <old> <new>
	...
	/**
	 * Sync madxartwork Library.
	 *
	 * ## EXAMPLES
	 *
	 *  1. wp madxartwork sync-library
	 *      - This will sync the library with madxartwork cloud library.
	 *
	 * @since 2.1.0
	 * @access public
	 * @alias sync-library
	 ...
	 * ## EXAMPLES
	 *
	 *  1. wp madxartwork import-library <file-path>
