...
include_once madxartwork_PATH . '/includes/libraries/wp-background-process/wp-async-request.php';
include_once madxartwork_PATH . '/includes/libraries/wp-background-process/wp-background-process.php';
...
abstract class Background_Task extends \WP_Background_Process {
	...
	public function schedule_cron_healthcheck( $schedules ) {
		...
		$schedules[ $this->identifier . '_cron_interval' ] = array(
			...
			'display' => sprintf( __( 'Every %d minutes', 'madxartwork' ), $interval ),
		);
	...
	/**
	 * @var \madxartwork\Core\Base\Background_Task_Manager
	 */
	protected $manager;
	...
	public function __construct( $manager ) {
		...
		$this->prefix = 'madxartwork_' . get_current_blog_id();
