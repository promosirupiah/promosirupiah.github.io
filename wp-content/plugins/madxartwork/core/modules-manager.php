...
/**
 * madxartwork modules manager.
 *
 * madxartwork modules manager handler class is responsible for registering and
 * managing madxartwork modules.
 *
 * @since 1.6.0
 */
class Modules_Manager {
	 ...
	 *
	 * Initializing the madxartwork modules manager.
	 *
	 * @since 1.6.0
	 * @access public
	 */
