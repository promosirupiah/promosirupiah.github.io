...
/**
 * madxartwork page settings manager.
 *
 * madxartwork page settings manager handler class is responsible for registering
 * and managing madxartwork page settings managers.
 *
 * @since 1.6.0
 */
class Manager extends BaseManager {
	 ...
	 */
	const META_KEY = '_madxartwork_page_settings';
