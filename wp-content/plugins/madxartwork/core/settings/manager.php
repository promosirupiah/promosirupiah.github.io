<?php
namespace madxartwork\Core\Settings;
...
/**
 * madxartwork settings manager.
 *
 * madxartwork settings manager handler class is responsible for registering and
 * managing madxartwork settings managers.
 *
 * @since 1.6.0
 */
class Manager {
	 ...
	 *
	 * Holds the names for builtin madxartwork settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 *
	 ...
	 *
	 * Register builtin madxartwork settings managers.
	 *
	 * @since 1.6.0
	 * @access private
	 * @static
