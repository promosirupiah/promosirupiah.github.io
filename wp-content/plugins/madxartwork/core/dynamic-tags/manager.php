...
class Manager {
	...
	const TAG_LABEL = 'madxartwork-tag';
	 ...
	 *
	 * Initializing madxartwork dynamic tags manager.
	 *
	 * @since 2.0.0
	 * @access public
	 */
	...
	public function get_tags() {
		if ( ! did_action( 'madxartwork/dynamic_tags/register_tags' ) ) {
			/**
			 * Register dynamic tags.
			 *
			 * Fires when madxartwork registers dynamic tags.
			 *
			 * @since 2.0.9
			 *
			 * @param Manager $this Dynamic tags manager.
			 */
			do_action( 'madxartwork/dynamic_tags/register_tags', $this );
		}
	...
	public function ajax_render_tags( $data ) {
		 ...
		 *
		 * Fires before madxartwork renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
		do_action( 'madxartwork/dynamic_tags/before_render' );
		 ...
		 *
		 * Fires after madxartwork renders the dynamic tags.
		 *
		 * @since 2.0.0
		 */
		do_action( 'madxartwork/dynamic_tags/after_render' );
	...
	private function add_actions() {
		...
		add_action( 'madxartwork/css-file/post/enqueue', [ $this, 'after_enqueue_post_css' ] );
	}
}
