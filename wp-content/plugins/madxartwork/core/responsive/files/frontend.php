...
namespace madxartwork\Core\Responsive\Files;

use madxartwork\Core\Files\Base;
...
class Frontend extends Base {
	...
	const META_KEY = 'madxartwork-custom-breakpoints-files';
	...
	public function parse_content() {
		...
		$file_content = preg_replace_callback( '/madxartwork_SCREEN_([A-Z]+)_([A-Z]+)/', function ( $placeholder_data ) use ( $breakpoints_keys, $breakpoints ) {
