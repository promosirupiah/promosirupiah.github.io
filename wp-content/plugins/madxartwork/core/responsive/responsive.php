<?php
namespace madxartwork\Core\Responsive;

use madxartwork\Core\Responsive\Files\Frontend;
...
/**
 * madxartwork responsive.
 *
 * madxartwork responsive handler class is responsible for setting up madxartwork
...
class Responsive {
	...
	/**
	 * The madxartwork breakpoint prefix.
	 */
	const BREAKPOINT_OPTION_PREFIX = 'madxartwork_viewport_';
	...
	public static function get_stylesheet_templates_path() {
		return madxartwork_ASSETS_PATH . 'css/templates/';
	}
	...
	private static function get_stylesheet_templates() {
		...
		return apply_filters( 'madxartwork/core/responsive/get_stylesheet_templates', $templates );
	}
}
