...
class Manager {
	 ...
	 *
	 * Initializing the madxartwork files manager.
	 *
	 * @since 1.2.0
	 * @access public
	 */
	 ...
	 * export won't contain the post CSS file data used by madxartwork.
	 *
	...
	public function clear_cache() {
		...
		/**
		 * madxartwork clear files.
		 *
		 * Fires after madxartwork clears files
		 *
		 * @since 2.1.0
		 */
		do_action( 'madxartwork/core/files/clear_cache' );
	}
