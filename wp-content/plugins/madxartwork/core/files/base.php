...
abstract class Base {
	...
	public function __construct( $file_name ) {
		 ...
		 * @param object $this The file instance, which inherits madxartwork\Core\Files
		 */
		$file_name = apply_filters( 'madxartwork/files/file_name', $file_name, $this );
