...
namespace madxartwork\Core\Common\Modules\Finder;
 ...
 * Finder Module
 *
 * Responsible for initializing madxartwork Finder functionality
 */
class Module extends BaseModule {
	...
	protected function get_init_settings() {
		...
		$categories_data = apply_filters( 'madxartwork/finder/categories', $categories_data );

		return [
			'data' => $categories_data,
			'i18n' => [
				'finder' => __( 'Finder', 'madxartwork' ),
			],
		];
	}
}
