...
use madxartworkPro\Modules\ThemeBuilder\ThemeSupport\GeneratePress_Theme_Support;
use madxartworkPro\Modules\ThemeBuilder\ThemeSupport\Safe_Mode_Theme_Support;
	...
	public function init() {
		...
		switch ( $theme->get_template() ) {
			case 'generatepress':
				...
				break;
			case 'madxartwork-safe':
				new Safe_Mode_Theme_Support();
				break;
		}

		add_action( 'madxartwork/theme/register_locations', [ $this, 'after_register_locations' ], 99 );
	}
