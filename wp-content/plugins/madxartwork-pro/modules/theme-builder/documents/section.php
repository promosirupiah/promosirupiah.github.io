...
class Section extends Theme_Section_Document {
	...
	public static function get_title() {
		return __( 'Section', 'madxartwork-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'location_settings',
			[
				'label' => __( 'Location Settings', 'madxartwork-pro' ),
	...
	public function save_settings( $settings ) {
		if ( isset( $settings['location'] ) ) {
			if ( empty( $settings['location'] ) ) {
				$this->delete_main_meta( '_madxartwork_location' );
			} else {
				$this->update_main_meta( '_madxartwork_location', $settings['location'] );
