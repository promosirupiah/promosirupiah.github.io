...
class Post_Navigation extends Base {
	...
	public function get_title() {
		return __( 'Post Navigation', 'madxartwork-pro' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Post Navigation', 'madxartwork-pro' ),
			]
		);
		...
		$this->add_control(
			'prev_label',
			[
				'label' => __( 'Previous Label', 'madxartwork-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Previous', 'madxartwork-pro' ),
				'condition' => [
					'show_label' => 'yes',
				],
			]
		...
		$this->add_control(
			'next_label',
			[
				'label' => __( 'Next Label', 'madxartwork-pro' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Next', 'madxartwork-pro' ),
				'condition' => [
					'show_label' => 'yes',
				],
			]
		...
		$this->add_control(
			'arrow',
			[
				'label' => __( 'Arrows Type', 'madxartwork-pro' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fa fa-angle-left' => __( 'Angle', 'madxartwork-pro' ),
					'fa fa-angle-double-left' => __( 'Double Angle', 'madxartwork-pro' ),
					'fa fa-chevron-left' => __( 'Chevron', 'madxartwork-pro' ),
					'fa fa-chevron-circle-left' => __( 'Chevron Circle', 'madxartwork-pro' ),
					'fa fa-caret-left' => __( 'Caret', 'madxartwork-pro' ),
					'fa fa-arrow-left' => __( 'Arrow', 'madxartwork-pro' ),
					'fa fa-long-arrow-left' => __( 'Long Arrow', 'madxartwork-pro' ),
					'fa fa-arrow-circle-left' => __( 'Arrow Circle', 'madxartwork-pro' ),
					'fa fa-arrow-circle-o-left' => __( 'Arrow Circle Negative', 'madxartwork-pro' ),
				],
		...
		$this->add_control(
			'show_title',
			[
				'label' => __( 'Post Title', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'madxartwork-pro' ),
				'label_off' => __( 'Hide', 'madxartwork-pro' ),
				'default' => 'yes',
		...
		$this->add_control(
			'show_borders',
			[
				'label' => __( 'Borders', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'madxartwork-pro' ),
				'label_off' => __( 'Hide', 'madxartwork-pro' ),
				'default' => 'yes',
				'prefix_class' => 'madxartwork-post-navigation-borders-',
			]
		);
		...
		$this->add_control(
			'in_same_term',
			[
				'label' => __( 'In same Term', 'madxartwork-pro' ),
				'type' => Controls_Manager::SELECT2,
				'options' => $post_type_options,
				'default' => '',
				'multiple' => true,
				'label_block' => true,
				'description' => __( 'Indicates whether next post must be within the same taxonomy term as the current post, this lets you set a taxonomy per each post type', 'madxartwork-pro' ),
			]
		);
		...
		foreach ( $post_type_options as $post_type => $post_type_label ) {
			$this->add_control(
				$post_type . '_taxonomy',
				[
					'label' => $post_type_label . ' ' . __( 'Taxonomy', 'madxartwork-pro' ),
					'type' => Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			'arrow_style',
			[
				'label' => __( 'Arrow', 'madxartwork-pro' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_arrow' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				...
				//'default' => '#D4D4D4',
				'selectors' => [
					'{{WRAPPER}} .madxartwork-post-navigation__separator' => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .madxartwork-post-navigation' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .madxartwork-post-navigation__separator' => 'width: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .madxartwork-post-navigation' => 'border-top-width: {{SIZE}}{{UNIT}}; border-bottom-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .madxartwork-post-navigation__next.madxartwork-post-navigation__link' => 'width: calc(50% - ({{SIZE}}{{UNIT}} / 2))',
					'{{WRAPPER}} .madxartwork-post-navigation__prev.madxartwork-post-navigation__link' => 'width: calc(50% - ({{SIZE}}{{UNIT}} / 2))',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
					'{{WRAPPER}} .madxartwork-post-navigation' => 'padding: {{SIZE}}{{UNIT}} 0;',
				],
				'range' => [
					'em' => [
						'min' => 0,
	...
	protected function render() {
		...
		if ( 'yes' === $settings['show_arrow'] ) {
			...
			$prev_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-prev"><i class="' . $prev_icon_class . '" aria-hidden="true"></i><span class="madxartwork-screen-only">' . esc_html__( 'Prev', 'madxartwork-pro' ) . '</span></span>';
			$next_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-next"><i class="' . $next_icon_class . '" aria-hidden="true"></i><span class="madxartwork-screen-only">' . esc_html__( 'Next', 'madxartwork-pro' ) . '</span></span>';
		}
		...
		?>
		<div class="madxartwork-post-navigation madxartwork-grid">
			<div class="madxartwork-post-navigation__prev madxartwork-post-navigation__link">
				<?php previous_post_link( '%link', $prev_arrow . '<span class="madxartwork-post-navigation__link__prev">' . $prev_label . $prev_title . '</span>', $in_same_term, '', $taxonomy ); ?>
			</div>
			<?php if ( 'yes' === $settings['show_borders'] ) : ?>
				<div class="madxartwork-post-navigation__separator-wrapper">
					<div class="madxartwork-post-navigation__separator"></div>
				</div>
			<?php endif; ?>
			<div class="madxartwork-post-navigation__next madxartwork-post-navigation__link">
				<?php next_post_link( '%link', '<span class="madxartwork-post-navigation__link__next">' . $next_label . $next_title . '</span>' . $next_arrow, $in_same_term, '', $taxonomy ); ?>
			</div>
		</div>
		<?php
	}
