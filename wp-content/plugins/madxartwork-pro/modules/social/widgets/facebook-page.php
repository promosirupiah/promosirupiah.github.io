...
class Facebook_Page extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Facebook Page', 'madxartwork-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'description' => __( 'Paste the URL of the Facebook page.', 'madxartwork-pro' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'timeline' => __( 'Timeline', 'madxartwork-pro' ),
					'events' => __( 'Events', 'madxartwork-pro' ),
					'messages' => __( 'Messages', 'madxartwork-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'small_header',
			[
				'label' => __( 'Small Header', 'madxartwork-pro' ),
		...
		$this->add_control(
			'show_cover',
			[
				'label' => __( 'Cover Photo', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'show_facepile',
			[
				'label' => __( 'Profile Photos', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'show_cta',
			[
				'label' => __( 'Custom CTA Button', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
	...
	public function render() {
		...
		$attributes = [
			'class' => 'madxartwork-facebook-widget fb-page',
