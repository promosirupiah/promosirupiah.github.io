...
class Facebook_Button extends Widget_Base {
	...
	public function get_title() {
		return __( 'Facebook Button', 'madxartwork-pro' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'like',
				'options' => [
					'like' => __( 'Like', 'madxartwork-pro' ),
					'recommend' => __( 'Recommend', 'madxartwork-pro' ),
					/* TODO: remove on 2.3 */
					'follow' => __( 'Follow', 'madxartwork-pro' ) . ' (' . __( 'Deprecated', 'madxartwork-pro' ) . ')',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'The Follow button has been deprecated by Facebook and will no longer work.', 'madxartwork-pro' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'standard',
				'options' => [
					'standard' => __( 'Standard', 'madxartwork-pro' ),
					'button' => __( 'Button', 'madxartwork-pro' ),
					'button_count' => __( 'Button Count', 'madxartwork-pro' ),
					'box_count' => __( 'Box Count', 'madxartwork-pro' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'small',
				'options' => [
					'small' => __( 'Small', 'madxartwork-pro' ),
					'large' => __( 'Large', 'madxartwork-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'color_scheme',
			[
				'label' => __( 'Color Scheme', 'madxartwork-pro' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'light',
				'options' => [
		...
		$this->add_control(
			'show_share',
			[
				'label' => __( 'Share Button', 'madxartwork-pro' ),
		...
		$this->add_control(
			'show_faces',
			[
				'label' => __( 'Faces', 'madxartwork-pro' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
			]
		);
	...
	public function render() {
		...
		switch ( $settings['type'] ) {
			...
			case 'follow':
				if ( Plugin::madxartwork()->editor->is_edit_mode() ) {
					echo __( 'The Follow button has been deprecated by Facebook and will no longer work.', 'madxartwork-pro' );
		...
		switch ( $settings['type'] ) {
			...
			case 'recommend':
				...
				$attributes['class'] = 'madxartwork-facebook-widget fb-like';
