<?php
namespace madxartworkPro\Modules\ShareButtons;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_filter( 'madxartwork_pro/frontend/localize_settings', [ $this, 'add_localize_data' ] );

		add_filter( 'madxartwork_pro/editor/localize_settings', [ $this, 'add_localize_data' ] );
