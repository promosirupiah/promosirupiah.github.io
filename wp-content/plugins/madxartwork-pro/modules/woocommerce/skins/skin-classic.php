<?php
namespace madxartworkPro\Modules\Woocommerce\Skins;

use madxartwork\Controls_Manager;
use madxartwork\Skin_Base;
use madxartwork\Widget_Base;
use madxartworkPro\Modules\Woocommerce\Module;
use madxartworkPro\Modules\Woocommerce\Widgets\Products;
...
class Skin_Classic extends Skin_Base {
	...
	protected function _register_controls_actions() {
		add_action( 'madxartwork/element/wc-products/section_layout/after_section_start', [ $this, 'register_controls' ] );
	}
