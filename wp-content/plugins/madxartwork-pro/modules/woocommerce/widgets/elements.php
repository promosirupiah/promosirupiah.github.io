...
class Elements extends Widget_Base {
	...
	public function get_title() {
		return __( 'WooCommerce Pages', 'madxartwork-pro' );
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'woocommerce_cart' => __( 'Cart Page', 'madxartwork-pro' ),
					'product_page' => __( 'Single Product Page', 'madxartwork-pro' ),
					'woocommerce_checkout' => __( 'Checkout Page', 'madxartwork-pro' ),
					'woocommerce_order_tracking' => __( 'Order Tracking Form', 'madxartwork-pro' ),
					'woocommerce_my_account' => __( 'My Account', 'madxartwork-pro' ),
				],
			]
		);
		...
		switch ( $settings['element'] ) {
			...
			case 'product_page':
				...
				if ( empty( $product ) && current_user_can( 'manage_options' ) ) {
					return __( 'Please set a valid product', 'madxartwork-pro' );
				}
	...
	protected function render() {
		...
		if ( 'woocommerce_checkout' === $this->get_settings( 'element' ) && '<div class="woocommerce"></div>' === $html ) {
			$html = '<div class="woocommerce">' . __( 'Your cart is currently empty.', 'madxartwork-pro' ) . '</div>';
		}
