...
class Archive_Products extends Products {
	...
	public function get_title() {
		return __( 'Archive Products', 'madxartwork-pro' );
	}
	...
	protected function _register_controls() {
		...
		if ( ! get_theme_support( 'woocommerce' ) ) {
			$this->add_control(
				...
				[
					...
					'raw' => __( 'Looks like you are using WooCommerce, while your theme does not support it. Please consider switching themes.', 'madxartwork-pro' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'To change the Products Archive’s layout, go to Appearance > Customize.', 'madxartwork-pro' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'The editor preview might look different from the live site. Please make sure to check the frontend.', 'madxartwork-pro' ),
				'content_classes' => 'madxartwork-panel-alert madxartwork-panel-alert-warning',
			]
		);
