...
class Product_Add_To_Cart extends Widget_Base {
	...
	public function get_title() {
		return __( 'Add To Cart', 'madxartwork-pro' );
	}
	...
	protected function render() {
		...
		<div class="madxartwork-add-to-cart madxartwork-product-<?php echo esc_attr( wc_get_product()->get_type() ); ?>">
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'prefix_class' => 'madxartwork-add-to-cart%s--align-',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Variations', 'madxartwork-pro' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Select field', 'madxartwork-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '.woocommerce {{WRAPPER}} form.cart table.variations td.value select, .woocommerce div.product.madxartwork{{WRAPPER}} form.cart table.variations td.value:before',
			]
		);
