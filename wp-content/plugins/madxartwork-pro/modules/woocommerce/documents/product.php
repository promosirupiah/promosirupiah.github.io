<?php
namespace madxartworkPro\Modules\Woocommerce\Documents;
...
class Product extends Single {
	...
	public static function get_title() {
		return __( 'Single Product', 'madxartwork-pro' );
	}
	...
	public function enqueue_scripts() {
		...
		if ( Plugin::madxartwork()->preview->is_preview_mode( $this->get_main_id() ) ) {
			global $product;
	...
	public function get_depended_widget() {
		return Plugin::madxartwork()->widgets_manager->get_widget_types( 'woocommerce-product-data-tabs' );
	}
	...
	public function filter_body_classes( $body_classes ) {
		...
		if ( get_the_ID() === $this->get_main_id() || Plugin::madxartwork()->preview->is_preview_mode( $this->get_main_id() ) ) {
	...
	protected static function get_editor_panel_categories() {
		$categories = [
			'woocommerce-elements-single' => [
				'title' => __( 'Product', 'madxartwork-pro' ),
