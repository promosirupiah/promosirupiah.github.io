...
class Contact_URL extends Tag {
	...
	public function get_title() {
		return __( 'Contact URL', 'madxartwork-pro' );
	}
	...
	protected function _register_controls() {
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'sms' => __( 'SMS', 'madxartwork-pro' ),
					'whatsapp' => __( 'WhatsApp', 'madxartwork-pro' ),
					'skype' => __( 'Skype', 'madxartwork-pro' ),
					'messenger' => __( 'Messenger', 'madxartwork-pro' ),
					'viber' => __( 'Viber', 'madxartwork-pro' ),
					'waze' => __( 'Waze', 'madxartwork-pro' ),
					'google_calendar' => __( 'Google Calendar', 'madxartwork-pro' ),
					'outlook_calendar' => __( 'Outlook Calendar', 'madxartwork-pro' ),
					'yahoo_calendar' => __( 'Yahoo Calendar', 'madxartwork-pro' ),
				],
			]
		);
		...
		$this->add_control(
			'mail_to',
			[
				'label' => __( 'Email', 'madxartwork-pro' ),
		...
		$this->add_control(
			'mail_subject',
			[
				'label' => __( 'Subject', 'madxartwork-pro' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'email',
		...
		$this->add_control(
			'tel_number',
			[
				'label' => __( 'Number', 'madxartwork-pro' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
					'link_type' => [
						'tel',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => __( 'Contact', 'madxartwork-pro' ),
					'add' => __( 'Add', 'madxartwork-pro' ),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => __( 'Call', 'madxartwork-pro' ),
					'chat' => __( 'Chat', 'madxartwork-pro' ),
					'userinfo' => __( 'Show Profile', 'madxartwork-pro' ),
					'add' => __( 'Add to Contacts', 'madxartwork-pro' ),
					'voicemail' => __( 'Send Voice Mail', 'madxartwork-pro' ),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'waze_address',
			[
				'label' => __( 'Location', 'madxartwork-pro' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'waze',
		...
		$this->add_control(
			'event_start_date',
			[
				'label' => __( 'Start', 'madxartwork-pro' ),
