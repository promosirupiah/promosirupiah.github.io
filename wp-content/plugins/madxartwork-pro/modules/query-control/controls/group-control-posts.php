 ...
 * @deprecated since 2.5.0, use class Group_Control_Query and madxartwork_Post_Query
 */
class Group_Control_Posts extends Group_Control_Base {
	...
	protected function prepare_fields( $fields ) {
		...
		$post_types_options['by_id'] = __( 'Manual Selection', 'madxartwork-pro' );
		$post_types_options['current_query'] = __( 'Current Query', 'madxartwork-pro' );
	...
	public function get_query_args( $control_id_prefix, $settings ) {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'madxartwork_pro/query_control/get_query_args/current_query', $current_query_vars );
