...
class madxartwork_Related_Query extends madxartwork_Post_Query {
	...
	protected function get_fallback_query( $original_query ) {
		...
		$this->fallback_args = apply_filters( 'madxartwork/query/fallback_query_args', $this->fallback_args, $this->widget );
