...
abstract class Field_Base {
	...
	public function __construct() {
		...
		add_action( "madxartwork_pro/forms/render_field/{$field_type}", [ $this, 'field_render' ], 10, 3 );
		add_action( "madxartwork_pro/forms/validation/{$field_type}", [ $this, 'validation' ], 10, 3 );
		add_action( "madxartwork_pro/forms/process/{$field_type}", [ $this, 'process_field' ], 10, 3 );
		add_filter( 'madxartwork_pro/forms/field_types', [ $this, 'add_field_type' ] );
		add_filter( "madxartwork_pro/forms/sanitize/{$field_type}", [ $this, 'sanitize_field' ], 10, 2 );
		add_action( 'madxartwork/preview/enqueue_scripts', [ $this, 'add_preview_depends' ] );
