...
class Module extends Module_Base {
	/**
	 * @var \madxartworkPro\Modules\Forms\Classes\Action_Base[]
	 */
	private $form_actions = [];
	/**
	 * @var \madxartworkPro\Modules\Forms\Fields\Field_Base[]
	 */
	public $field_types = [];
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				'x_field' => __( '%s Field', 'madxartwork-pro' ),
			],
		] );
	...
	public function forms_panel_action_data( array $data ) {
		...
		/** @var \madxartworkPro\Modules\Forms\Classes\Integration_Base $integration */
	...
	public function __construct() {
		...
		if ( Classes\Ajax_Handler::is_form_submitted() ) {
			 ...
			 */
			do_action( 'madxartwork_pro/forms/form_submitted', $this );
		}
	}
}
